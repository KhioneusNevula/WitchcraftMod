...
public class BlockFilterDataType extends BlockBase {
	
	public static final PropertyDirection SIDE_PLACED = PropertyDirection.create("side_placed");

	public BlockFilterDataType(String name) {
		super(name, Material.ANVIL, true, null, CreativeTabs.MISC);
		this.setTileEntity("data_filter", MagicTypeFilterBlock.class);
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
			ItemStack stack) {
		MagicTypeFilterBlock wire = (MagicTypeFilterBlock) worldIn.getTileEntity(pos);
		wire.resetInputSide();
